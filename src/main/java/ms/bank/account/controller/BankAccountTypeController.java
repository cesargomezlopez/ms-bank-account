...
public class BankAccountTypeController {
  ...
  @ApiOperation(value = "Find all Bank Account Types",
      notes = "Find all Bank Account Types registered")
  ...
  @ApiOperation(value = "Find Bank Account Type by id",
      notes = "Find Bank Account Type registered by id")
  public Mono<ResponseEntity<BankAccountType>>
      findBankAccountTypeById(@RequestParam("id")String id) {
  ...
  public Mono<ResponseEntity<BankAccountType>>
      createBankAcountType(@Valid @RequestBody BankAccountType bankAccountType) {
  ...
  public Mono<ResponseEntity<BankAccountType>>
      updateBankAcountType(@Valid @RequestBody BankAccountType bankAccountType) {
  ...
  @ApiOperation(value = "Deletes a Bank Account Type by id",
      notes = "Removes a Bank Account Type registered by id")
